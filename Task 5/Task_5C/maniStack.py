...
def tf_listener_and_broadcaster(tf_listener):
    ...
    try :
        ...
        # print("lct",(tf_listener.getLatestCommonTime("/ebot_base", "/yellow_bell_pepper")) == True)
        # print("lct",(tf_listener.getLatestCommonTime("/ebot_base", "/yellow_bell_pepper")))
        # print("rt",rospy.Time.now())
        # print("rt",rospy.Time(0))
        # print("rt",rospy.Time())
...
def main():
        ...
        if((len(yellow_Cordinates) !=0 or len(red_Cordinates) !=0) and bot_Status == "stop" ):
            try:
                if(len(yellow_Cordinates) !=0):
                    ...
                    # get_fruit(yellow_Cordinates, yellow_basket,"yellow_bell_pepper", lst_joint_angles_scan, tf_listener)
                    rospy.sleep(5)

                    # print("Sleeping in yellow")
                
                if(len(red_Cordinates) !=0):
                    # ur5.set_joint_angles(lst_joint_angles_picking_pose)
                    # TODO print("                    tring [RED] get_fruit")
                    print("red cordinates: ", red_Cordinates)
                    # get_fruit(red_Cordinates, red_basket, "red_bell_pepper", lst_joint_angles_scan, tf_listener)
                    rospy.sleep(5)
                    
                    # print("Sleeping in red")
                ...
                # print("bot_status ManiStack Finally: ",bot_Status)
                # print(rospy.Time.now())
                rospy.sleep(5)
                # print("Scan Ready")
                # print(rospy.Time.now())
    ...
    # ur5.set_joint_angles(lst_joint_angles_scan_right)
    # while not rospy.is_shutdown() and task_Status == '2':
    #     tf_listener_and_broadcaster(tf_listener)
    #     ur5.set_joint_angles(lst_joint_angles_scan_right)
