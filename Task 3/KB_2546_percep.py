...
def get_realWorld_Cordinates():
    ...
    tf_broadcaster(Xy, Yy, Zy, "yellow_bell_pepper", "camera_rgb_frame2")
    # tf_broadcaster(Xy, Yy, Zy, "fruit_yellow", "ebot_base")

    # get red fruit cordinates
    Xr, Yr, Zr = twoD_to_threeD(fruit_red[0][0], fruit_red[0][1], depth_val_red[0])
    tf_broadcaster(Xr, Yr, Zr, "red_bell_pepper", "camera_rgb_frame2")
    # tf_broadcaster(Xr, Yr, Zr, "fruit_red", "ebot_base")
...
def img_clbck(img_msg):
    ...
    pose, fruit_red, fruit_yellow  = image_processing(image)
...
def image_processing(image):
    ...
    ##########################################################################################
    return pose, fruit_red, fruit_yellow
