...
class Ur5Moveit_help:
    def __init__(self, pub_ee_pose_joint, pub_ee_pose_joint_wait_ack):
        ...
        # self._group.set_planner_id("KPIECE")
    ...
    def set_pose(self, arg_pose):
        ...
        # waypoint.append(arg_pose)
        self._group.set_pose_target(arg_pose)
        # path,fraction = self._group.compute_cartesian_path(waypoint, 0.01, 0.0)
